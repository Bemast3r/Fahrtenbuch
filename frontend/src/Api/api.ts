...
export async function login(loginData: { username: string, password: string }): Promise<LoginResource> {
    ...
    const response = await fetch(`https://fahrtenbuch.vercel.app/api/login`, {
        method: "POST",
        headers: {
...
export async function getUser(userID: string): Promise<UserResource> {
    try {
        ...
        if (!jwt2)
            throw new Error("no jwt found");
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/user/admin/finde/user/${userID}`, {
            method: "GET",
            headers: {
...
export async function postFahrt(fahrt: FahrtResource): Promise<FahrtResource> {
    try {
        const jwt2 = getJWT();
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/fahrt/user/fahrt/erstellen`, {
            method: "POST",
            headers: {
                "Authorization": `Bearer ${jwt2}`,
                "Content-Type": "application/json"
...
export async function getFahrt(userID: string): Promise<FahrtResource[]> {
    try {
        ...
        if (!jwt2)
            throw new Error("no jwt found");
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/fahrt/admin/fahrt/user/${userID}`, {
            method: "GET",
            headers: {
                "Authorization": `Bearer ${jwt2}`
            }
...
export async function updateFahrt(fahrt: FahrtResource): Promise<FahrtResource> {
    try {
        ...
        const jwt2 = getJWT();
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/fahrt/user/fahrt/bearbeiten/${fahrt._id}`, {
            method: "PUT",
            headers: {
                "Authorization": `Bearer ${jwt2}`,
                "Content-Type": "application/json"
...
export async function passwortVergessen(email: string) {
    try {
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/user/passwort-vergessen`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
export async function passwortZuruecksetzen(token: string, password: string) {
    try {
        ...
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/user/passwort-zuruecksetzen/${token}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
export async function createUserWithAdmin(user: UserResource): Promise<UserResource> {
    try {
        ...
        const response = await fetch("https://fahrtenbuch.vercel.app/api/user/admin/user-erstellen", {
            method: "POST",
            headers: {
                "Authorization": `Bearer ${jwt2}`,
                "Content-Type": "application/json"
...
export async function getCompletedTrips(): Promise<FahrtResource[]> {
    try {
        const jwt2 = getJWT();
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/fahrt/admin/beendete/fahrten`, {
            method: "GET",
            headers: {
                "Authorization": `Bearer ${jwt2}`
            }
...
export async function getOngoingTrips(): Promise<FahrtResource[]> {
    try {
        const jwt2 = getJWT();
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/fahrt/admin/laufende/fahrten`, {
            method: "GET",
            headers: {
                "Authorization": `Bearer ${jwt2}`
            }
...
export async function getAlleAdmin(): Promise<UserResource[]> {
    try {
        const jwt2 = getJWT();
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/user/admin/finde/user/alle/admin`, {
            method: "GET",
            headers: {
                "Authorization": `Bearer ${jwt2}`
            }
...
export async function getAlleUser(): Promise<UserResource[]> {
    try {
        const jwt2 = getJWT();
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/user/admin/finde/user/alle/user`, {
            method: "GET",
            headers: {
                "Authorization": `Bearer ${jwt2}`
            }
...
export async function getAllFahrts(): Promise<FahrtResource[]> {
    try {
        ...
        if (!jwt2)
            throw new Error("no jwt found");
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/fahrt/admin/alle/fahrten/`, {
            method: "GET",
            headers: {
                "Authorization": `Bearer ${jwt2}`
            }
...
export async function deleteFahrt(fahrt: FahrtResource): Promise<void> {
    try {
        ...
        const response = await fetch(`https://fahrtenbuch.vercel.app/api/fahrt/admin/loesch/fahrt/${fahrt._id}`, {
            method: "DELETE",
            headers: {
                "Authorization": `Bearer ${jwt}`
            }
