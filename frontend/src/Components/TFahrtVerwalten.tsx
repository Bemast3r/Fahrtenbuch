        ...
        {loading ? (
          ...
          <div className="container">
            ...
            {letzteFahrt && !letzteFahrt.beendet ? (
              ...
              <>
                <p>
                  {letzteFahrt ? 'Ihre letzte Fahrt endete am ' + new Date(letzteFahrt.createdAt!).toLocaleDateString('de-DE') + ' um ' + new Date(letzteFahrt.createdAt!).toLocaleTimeString('de-DE') + '. ' : 'Keine Fahrt gefunden.'}
                </p>
                <Link to="/">
          ...
          <Form noValidate validated={validated} id="endModalForm">
            <Form.Group controlId="formBasicEnd">
              ...
              <Form.Control.Feedback type="invalid">
                Bitte geben Sie den Kilometerstand am Ende ein.
            ...
            <Form.Group controlId="formBasicEndOrt">
              ...
              />
              <Form.Control.Feedback type="invalid">
                Bitte geben Sie den Ort der Fahrtbeendigung ein.
              </Form.Control.Feedback>
            </Form.Group>
          </Form>
        </Modal.Body>
