  ...
  const FahrtVerwalten: React.FC = () => {
    ...
    useEffect(() => {
      if (elapsedTimeLenkzeit === 0 && !letzteFahrt?.beendet) {
        ...
        console.log(localStorage.getItem("isPause"))

        console.log(localStorage.getItem("isArbeitszeit"))

        console.log(localStorage.getItem("isLenkzeit"))
        ...
        if (storedElapsedTimeLenkzeit) {
          ...
          if (storedisPause === "false" && storedisArbeitszeit === "false" && storedisTimeLenkzeit === "false") {
            setIsRecordingLenkzeit(true);
            toggleRecordingLenkzeit();
          }
        }
    ...
    function toggleRecordingLenkzeit() {
      ...
      console.log("First is Recording", isRecordingLenkzeit)
      stopRunningTimer();
      console.log("is Recording",isRecordingLenkzeit)
      ...
      if (isRecordingLenkzeit) {
        ...
        // Soll nur ausgeführt werden wenn man den Status wechselt und somit dann den Post macht.
        const lastRecord = lenkzeitRecord
        if (lastRecord && lastRecord.stop === null) {
