...
const FahrtVerwalten: React.FC = () => {
  ...
  //         arbeitszeitRecord.start = new Date(new Date(letzteFahrt.lenkzeit![letzteFahrt.lenkzeit!.length - 1].stop!).getTime() + 2000  - missingTime);
  //       } else if (localStorage.getItem("last") === "Pause" && letzteFahrt.pause && letzteFahrt.pause.length > 0) {
  //         arbeitszeitRecord.start = new Date(new Date(letzteFahrt.pause![letzteFahrt.pause!.length - 1].stop!).getTime() + 2000 - missingTime);
  //       }
  //       const fahrtResource: FahrtResource = {
  ...
  //       if (localStorage.getItem("last") === "Lenkzeit" && letzteFahrt.lenkzeit && letzteFahrt.lenkzeit?.length > 0) {
  //         pauseRecord.start = new Date(new Date(letzteFahrt.lenkzeit![letzteFahrt.lenkzeit!.length - 1].stop!).getTime() + 2000 - missingTime);
  //       } else if (localStorage.getItem("last") === "Arbeitszeit" && letzteFahrt.arbeitszeit && letzteFahrt.arbeitszeit.length > 0) {
  //         pauseRecord.start = new Date(new Date(letzteFahrt.arbeitszeit![letzteFahrt.arbeitszeit!.length - 1].stop!).getTime() + 2000- missingTime);
  //       }
  //       const fahrtResource: FahrtResource = {
  //         fahrerid: usercontexte.id!,
  //         id: letzteFahrt._id!.toString(),
  ...
  //       } else if (localStorage.getItem("last") === "Pause" && letzteFahrt.pause && letzteFahrt.pause?.length > 0) {
  //         lenkzeitRecord.start = new Date(new Date(letzteFahrt.pause![letzteFahrt.pause!.length - 1].stop!).getTime() + 2000 - missingTime );
  //       } else if (localStorage.getItem("last") === "Arbeitszeit" && letzteFahrt.arbeitszeit && letzteFahrt.arbeitszeit.length > 0) {
  //         lenkzeitRecord.start = new Date(new Date(letzteFahrt.arbeitszeit![letzteFahrt.arbeitszeit!.length - 1].stop!).getTime() + 2000 - missingTime);
  //       }
  ...
  return (
    <div>
      <p>Dies ist ein einzelnes Paragraph-Element.</p>
    </div>
  );
}
